...
def financial_summary():
    ...
    try:
        ...
        # FIXED: Send actual investment amounts, not refund amounts
        savings = {
            "invested80C": total_80c_investment,  # Actual PPF + ELSS invested
            "invested80D": total_80d_investment   # Actual Insurance premium paid
        }
        ...
        print(f"   Actual 80C Invested: ₹{total_80c_investment}")
        print(f"   Actual 80D Invested: ₹{total_80d_investment}")
        ...
        return jsonify({
            ...
            "savings": savings  # Now sends actual investment amounts!
        })
